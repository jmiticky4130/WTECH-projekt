<div x-show="modal === 'register'" x-cloak class="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
  <div class="bg-white w-full max-w-md relative shadow-xl" @click.stop>
    ...
    <div class="px-5 py-8 sm:px-10 sm:py-10">
      ...
      @if ($errors->has('first_name') || $errors->has('last_name') || $errors->has('email') || $errors->has('password'))
        <div class="bg-red-50 border border-red-200 text-red-700 text-sm px-4 py-3 mb-4 space-y-1">
      ...
      <form action="{{ route('register') }}" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Meno"
              class="w-full border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:border-brand-dark @error('first_name') border-red-400 @enderror"
            />
          </div>
          <div>
            <label class="block text-sm font-medium mb-1.5">
            ...
            <input
              ...
              class="w-full border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:border-brand-dark @error('last_name') border-red-400 @enderror"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="w-full border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:border-brand-dark @error('email') border-red-400 @enderror"
          />
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              class="w-full border border-gray-300 px-4 py-2.5 pr-12 text-sm focus:outline-none focus:border-brand-dark @error('password') border-red-400 @enderror"
            />
      ...
      <p class="text-sm text-center text-gray-500 mt-6">
        Už máte účet?
        <a href="#" @click.prevent="modal = 'login'" class="text-brand-dark font-medium underline hover:text-brand-accent transition-colors">Prihláste sa</a>
      </p>
    </div>
  </div>
</div>
